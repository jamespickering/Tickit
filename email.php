...
<html>
	...
	<style type="text/css">
		...
		.mailslots, .mailslots-row, .mailslots-from{
	...
	<body>
		...
		<div class="container">
			...
			<div class="container-right">
				<a href="#" class="teacher link-local">Inbox</a>
				<a href="#" class="teacher link-local">Sent</a>	
				<a href="#" class="teacher link-local">Contacts</a>	<br>		
				<a href="newmail.html"><button class="btn" type="file">New Message</button></a>
				<hr>
				<div>
					<table class="mailslots">
						<tr class="mailslots-row">
							<td class="mailslots-subject"><a href="messagecont.html">You do the work noah?</a></td>
							<td class="mailslots-from">From:<a href="profile.html"> James Pickering</a></td>
						</tr>
						<tr class="mailslots-row2">
							<td class="mailslots-subject"><a href="messagecont.html">Money boi they call me</a></td>
							<td class="mailslots-from">From:<a href="profile.html"> Elliot Anderson</a></td>
						</tr>
